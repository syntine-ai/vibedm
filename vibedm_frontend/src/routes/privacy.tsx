...
export const Route = createFileRoute("/privacy")({
  head: () => ({ meta: [{ title: "Privacy Policy - Vibe DM" }] }),
    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="px-10 py-12 max-w-4xl mx-auto">
        ...
        <div className="prose prose-sm sm:prose-base dark:prose-invert max-w-none space-y-6 text-foreground/90">
          ...
          <h3 className="text-2xl font-bold mt-8 mb-4">Interpretation and Definitions</h3>

          <h4 className="text-xl font-semibold mt-6 mb-3">Interpretation</h4>
          <p>
          ...
          <h4 className="text-xl font-semibold mt-6 mb-3">Definitions</h4>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              ...
              this Agreement) refers to <strong>Syntine Labs</strong>.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to <strong>Vibe DM</strong>, accessible from <strong><a href="https://vibedm.syntine.com">https://vibedm.syntine.com</a></strong>
            </li>
            <li>
          ...
          <h3 className="text-2xl font-bold mt-8 mb-4">Collecting and Using Your Personal Data</h3>

          <h4 className="text-xl font-semibold mt-6 mb-3">Types of Data Collected</h4>

          <h5 className="font-semibold mt-4 mb-2">Personal Data</h5>
          <p>
          ...
          <h5 className="font-semibold mt-4 mb-2">Usage Data</h5>
          ...
          <h4 className="text-xl font-semibold mt-6 mb-3">Information from Third-Party Social Media Services</h4>
          <p>
            The Company allows You to create an account and log in to use the Service through
            Third-party Social Media Services, specifically integrating:
          </p>
          <ul className="list-disc pl-6 space-y-1">
          ...
          <h4 className="text-xl font-semibold mt-6 mb-3">Tracking Technologies and Cookies</h4>
          <p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              ...
              <em>Type:</em> Session Cookies<br />
              <em>Administered by:</em> Us<br />
              <em>Purpose:</em> These Cookies are essential to provide You with services available
            ...
            <li>
              ...
              <em>Type:</em> Persistent Cookies<br />
              <em>Administered by:</em> Us<br />
              <em>Purpose:</em> These Cookies identify if users have accepted the use of cookies on
              the Website.
            </li>
            <li>
              ...
              <em>Type:</em> Persistent Cookies<br />
              <em>Administered by:</em> Us<br />
              <em>Purpose:</em> These Cookies allow us to remember choices You make when You use the
          ...
          <h3 className="text-2xl font-bold mt-8 mb-4">Use of Your Personal Data</h3>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              <strong>To provide You with news, special offers and general information</strong> about
          ...
          <h4 className="text-xl font-semibold mt-6 mb-3">We may share Your personal information in the following situations:</h4>
          <ul className="list-disc pl-6 space-y-2">
            <li>
          ...
          <h3 className="text-2xl font-bold mt-8 mb-4">Retention of Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-2xl font-bold mt-8 mb-4">Transfer of Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-2xl font-bold mt-8 mb-4">Delete Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-2xl font-bold mt-8 mb-4">Disclosure of Your Personal Data</h3>

          <h4 className="text-xl font-semibold mt-6 mb-3">Business Transactions</h4>
          <p>
          ...
          <h3 className="text-2xl font-bold mt-8 mb-4">Security of Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-2xl font-bold mt-8 mb-4">Links to Other Websites</h3>
          <p>
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li><strong>By email:</strong> hello@syntine.com</li>
          </ul>
        </div>
      </div>
    </div>
