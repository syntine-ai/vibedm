    ...
    <div className="min-h-screen bg-background">
      <div className="px-10 py-8 max-w-[1000px] mx-auto">
        <div className="mb-8">
          <Link
            to="/login"
            className="inline-flex items-center gap-2 text-sm font-medium text-muted-foreground hover:text-foreground transition mb-4"
          >
        ...
        <div className="prose prose-sm sm:prose-base dark:prose-invert max-w-none space-y-6 text-foreground/90">
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              ...
              this Agreement) refers to Startlight Solutions, B-405, SG Homes, Vasundhara Sector – 3,
            ...
            <li>
              <strong>Website</strong> refers to Vibe DM, accessible from our official domains.
            </li>
            <li>
          ...
          <h3 className="text-lg font-semibold mt-6 mb-3">Tracking Technologies and Cookies</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold mt-6 mb-3">Business Transactions</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold mt-6 mb-3">Law enforcement</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold mt-6 mb-3">Other legal requirements</h3>
          <p>
